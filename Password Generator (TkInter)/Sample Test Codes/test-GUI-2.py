...
entry = Entry(root,text="enter text here",font=('Ubuntu',12))
entry.grid(row=0, column=0,sticky='E',padx=10,pady=10)

# create label for length of password 
c_label = Label(root, text="Select Length Here") 
...
entry1=Entry(root, text="enter text here",font=('Ubuntu',18))
entry1.grid(row=8,column=0,sticky='E')
